      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <p className="text-blue-400 text-xs font-bold uppercase tracking-widest mb-4">Solutions → Marketing</p>
            <h1 className="text-5xl font-bold mb-6">Marketing teams love Collabo</h1>
            <p className="text-gray-400 text-xl mb-10 max-w-2xl">
              Plan campaigns, coordinate launches, and track content production — all in one place.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
            {[
              { icon: "📣", title: "Campaign Planning", desc: "Plan and execute marketing campaigns from ideation to results analysis." },
              { icon: "📅", title: "Content Calendar", desc: "Visual calendar view for content scheduling across all channels." },
              { icon: "📈", title: "Campaign Analytics", desc: "Track campaign performance and report results to stakeholders." },
            ].map((f) => (
