      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <p className="text-blue-400 text-xs font-bold uppercase tracking-widest mb-4">Solutions → Operations</p>
            <h1 className="text-5xl font-bold mb-6">Operations teams run smoother</h1>
            <p className="text-gray-400 text-xl mb-10 max-w-2xl">
              Streamline processes, track workflows, and keep operations running efficiently with Collabo.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
            {[
              { icon: "⚙️", title: "Process Management", desc: "Document and automate business processes with clear workflows and checklists." },
              { icon: "📋", title: "SOP Tracking", desc: "Create, manage, and track standard operating procedures across teams." },
              { icon: "🔄", title: "Workflow Automation", desc: "Automate repetitive tasks and approvals to save time and reduce errors." },
            ].map((f) => (
