      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <p className="text-blue-400 text-xs font-bold uppercase tracking-widest mb-4">Solutions → Engineering</p>
            <h1 className="text-5xl font-bold mb-6">Built for engineering teams</h1>
            <p className="text-gray-400 text-xl mb-10 max-w-2xl">
              From sprint planning to deployment tracking — Collabo gives engineering teams the tools to ship better software, faster.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
            {[
              { icon: "🏃", title: "Agile Sprints", desc: "Plan, execute, and review sprints with velocity tracking and burndown charts." },
              { icon: "🐛", title: "Bug Tracking", desc: "Capture bugs, assign severity, and track fixes through to resolution." },
              { icon: "🔗", title: "GitHub Sync", desc: "Link PRs and commits to tasks. See code changes right in your board." },
            ].map((f) => (
